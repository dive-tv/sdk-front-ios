...
open class Module : UITableViewCell, Validatable{
     ...
     */
    func setCardDetail (_ _configModule : ConfigModule, _cardDetail : CardDetail) {
    ...
    class func validate(_ data: CardDetail) throws {
